...
Terraform will perform the following actions:
  ...
  + resource "google_storage_bucket" "data-lake-bucket" {
      ...
      + id                          = (known after apply)
      + location                    = "EUROPE-CENTRAL2"
      + name                        = "dtc_data_lake_virtual-dynamo-375412"
...
google_storage_bucket.data-lake-bucket: Creation complete after 2s [id=dtc_data_lake_virtual-dynamo-375412]
google_bigquery_dataset.dataset: Creation complete after 3s [id=projects/virtual-dynamo-375412/datasets/trips_data_all]
